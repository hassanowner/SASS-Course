...
Â· Organizes related properties together

Â· Reduces repetition of property prefixes

Â· Makes code more readable and maintainable

Â· Follows a logical hierarchy
...
Â· The colon : after the parent property is required

Â· You can have a value on the parent property (like margin: auto)

Â· The parent property name acts as a prefix with a hyphen

Â· You can nest multiple levels deep
...
Â· Create reusable style blocks

Â· Reduce code duplication

Â· Keep your CSS DRY (Don't Repeat Yourself)

Â· No extra CSS generated unless extended
...
Â· The % symbol defines a placeholder

Â· The name main-box is the placeholder name

Â· Contains reusable styles: white background, padding, border

Â· This code alone produces NO CSS output

Â· It's like a template waiting to be used
...
Â· Takes all styles from %main-box
Â· Applies them to both .ads and .article
Â· Groups selectors together that share the same styles
Â· Adds unique styles to each selector
